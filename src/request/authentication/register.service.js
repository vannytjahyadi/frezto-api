...
var RegisterRequestService = /** @class */ (function () {
    function RegisterRequestService() {
    }
    RegisterRequestService.prototype.register = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var errors, userRepository, user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, userRepository.find({ email: req.body.email })];
                    case 1:
                        user = _a.sent();
                        if (user.length) {
                            Error_service_1.ErrorService.sendErrorResponse(res, 50001);
                            return [2 /*return*/, false];
                        }
                        else {
                            next();
